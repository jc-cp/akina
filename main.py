...
def main():
    ...
    def next_clicked():
        ...
        choices = get_selection()
        max_val, index, id, choices, makename, modelname, image_link, offer_link = hf.run(int(user_budget.get()))
    ...
    need_parsing = {"Driving Experience": "DRIVING_EXPERIENCE", "City Friendly": "CITY_FRIENDLY",
    ...
    buttons = [driving_button, city_button, sustainable_button, fuel_button, status_button, comfort_button,
               safety_button,
